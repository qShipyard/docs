# Source: https://github.com/qShipyard/narratorlog/blob/main/docs/05-pipeline-spec.md
...
[History](https://github.com/qShipyard/narratorlog/commits/main/docs/05-pipeline-spec.md)

Open commit details

History

465 lines (358 loc) · 15 KB
...
[Raw](https://github.com/qShipyard/narratorlog/raw/refs/heads/main/docs/05-pipeline-spec.md)
...
**Input:** Scan config (repository, branch, scan\_from, scan\_to, depth)
...
**Responsibility:** Extract surrounding codebase context for changed functions. Gives the AI understanding of what changed code _does_ in the wider system, not just what lines changed.
...
One AI call per configured audience. All calls run concurrently. Input is the collected Pass 1 summaries — not the raw commits.
