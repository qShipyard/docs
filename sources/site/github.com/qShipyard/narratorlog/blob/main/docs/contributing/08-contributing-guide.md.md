# Source: https://github.com/qShipyard/narratorlog/blob/main/docs/contributing/08-contributing-guide.md
...
[History](https://github.com/qShipyard/narratorlog/commits/main/docs/contributing/08-contributing-guide.md)

History

266 lines (186 loc) · 7.84 KB
...
[Raw](https://github.com/qShipyard/narratorlog/raw/refs/heads/main/docs/contributing/08-contributing-guide.md)
...
Web app: [http://localhost:3000](http://localhost:3000) API: [http://localhost:8080](http://localhost:8080)
...
For local development you need these in your environment (the values below match `docker-compose.dev.yml`):
