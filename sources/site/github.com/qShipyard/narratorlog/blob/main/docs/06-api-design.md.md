# Source: https://github.com/qShipyard/narratorlog/blob/main/docs/06-api-design.md
...
[History](https://github.com/qShipyard/narratorlog/commits/main/docs/06-api-design.md)

Open commit details

History

618 lines (481 loc) · 10.8 KB
...
[Raw](https://github.com/qShipyard/narratorlog/raw/refs/heads/main/docs/06-api-design.md)
...
Git providers are connected separately, not via auth: an admin saves a Personal Access Token per provider under Settings → Sources (`PUT /api/v1/team/config`, encrypted into the team config). See `GET /api/v1/sources` and `GET /api/v1/repos/available?provider=<github|gitlab|bitbucket>`.
