# Source: https://github.com/qShipyard/narratorlog/tree/refs/heads/fest/Refactor-scan-review
...
 refs/heads/fest/Refactor-scan-review
...
[56 Commits](https://github.com/qShipyard/narratorlog/commits/refs/heads/fest/Refactor-scan-review/)
...
[.github](https://github.com/qShipyard/narratorlog/tree/refs/heads/fest/Refactor-scan-review/.github '.github')
...
[apps](https://github.com/qShipyard/narratorlog/tree/refs/heads/fest/Refactor-scan-review/apps 'apps')
...
[deploy](https://github.com/qShipyard/narratorlog/tree/refs/heads/fest/Refactor-scan-review/deploy 'deploy')
...
[docs](https://github.com/qShipyard/narratorlog/tree/refs/heads/fest/Refactor-scan-review/docs 'docs')
...
[packages](https://github.com/qShipyard/narratorlog/tree/refs/heads/fest/Refactor-scan-review/packages 'packages')
...
[plugins](https://github.com/qShipyard/narratorlog/tree/refs/heads/fest/Refactor-scan-review/plugins 'plugins')
...
[.dockerignore](https://github.com/qShipyard/narratorlog/blob/refs/heads/fest/Refactor-scan-review/.dockerignore '.dockerignore')
...
[.gitignore](https://github.com/qShipyard/narratorlog/blob/refs/heads/fest/Refactor-scan-review/.gitignore '.gitignore')
...
[.narratorlog.yml](https://github.com/qShipyard/narratorlog/blob/refs/heads/fest/Refactor-scan-review/.narratorlog.yml '.narratorlog.yml')
...
[CONTRIBUTING.md](https://github.com/qShipyard/narratorlog/blob/refs/heads/fest/Refactor-scan-review/CONTRIBUTING.md 'CONTRIBUTING.md')
...
[LICENSE](https://github.com/qShipyard/narratorlog/blob/refs/heads/fest/Refactor-scan-review/LICENSE 'LICENSE')
...
[README.md](https://github.com/qShipyard/narratorlog/blob/refs/heads/fest/Refactor-scan-review/README.md 'README.md')
...
[ROADMAP.md](https://github.com/qShipyard/narratorlog/blob/refs/heads/fest/Refactor-scan-review/ROADMAP.md 'ROADMAP.md')
...
[package.json](https://github.com/qShipyard/narratorlog/blob/refs/heads/fest/Refactor-scan-review/package.json 'package.json')
...
[pnpm-lock.yaml](https://github.com/qShipyard/narratorlog/blob/refs/heads/fest/Refactor-scan-review/pnpm-lock.yaml 'pnpm-lock.yaml')
...
[pnpm-workspace.yaml](https://github.com/qShipyard/narratorlog/blob/refs/heads/fest/Refactor-scan-review/pnpm-workspace.yaml 'pnpm-workspace.yaml')
...
[turbo.json](https://github.com/qShipyard/narratorlog/blob/refs/heads/fest/Refactor-scan-review/turbo.json 'turbo.json')
...
For a production deployment behind nginx with TLS, see **[deploy/SETUP.md](https://github.com/qShipyard/narratorlog/blob/refs/heads/fest/Refactor-scan-review/deploy/SETUP.md)**. In short: copy `deploy/.env.example` to `.env`, fill in every value (generate `APP_SECRET` and `ENCRYPTION_KEY` with `openssl rand -hex 32` — the API and worker must share the same `ENCRYPTION_KEY`), apply migrations, then:
...
Read the [Contributing Guide](https://github.com/qShipyard/narratorlog/blob/refs/heads/fest/Refactor-scan-review/docs/contributing/08-contributing-guide.md) to get started.
...
| Doc | Description |
| --- | --- |
| [Problem Statement](https://github.com/qShipyard/narratorlog/blob/refs/heads/fest/Refactor-scan-review/docs/01-problem-statement.md) | Why narratorlog exists |
| [Product Requirements](https://github.com/qShipyard/narratorlog/blob/refs/heads/fest/Refactor-scan-review/docs/02-product-requirements.md) | What it does and for who |
| [Architecture](https://github.com/qShipyard/narratorlog/blob/refs/heads/fest/Refactor-scan-review/docs/03-architecture.md) | How it is built |
| [Database Schema](https://github.com/qShipyard/narratorlog/blob/refs/heads/fest/Refactor-scan-review/docs/04-database-schema.md) | Data model |
| [Pipeline Spec](https://github.com/qShipyard/narratorlog/blob/refs/heads/fest/Refactor-scan-review/docs/05-pipeline-spec.md) | The 8-stage pipeline |
| [API Design](https://github.com/qShipyard/narratorlog/blob/refs/heads/fest/Refactor-scan-review/docs/06-api-design.md) | REST API reference |
| [Plugin Interface](https://github.com/qShipyard/narratorlog/blob/refs/heads/fest/Refactor-scan-review/docs/07-plugin-interface-spec.md) | How to build plugins |
| [Contributing](https://github.com/qShipyard/narratorlog/blob/refs/heads/fest/Refactor-scan-review/docs/contributing/08-contributing-guide.md) | How to contribute |
