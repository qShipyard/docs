# Source: https://github.com/qShipyard/narratorlog/tree/feat/personal-pr-activity
...
[58 Commits](https://github.com/qShipyard/narratorlog/commits/feat/personal-pr-activity/)
...
[.github](https://github.com/qShipyard/narratorlog/tree/feat/personal-pr-activity/.github '.github')
...
[apps](https://github.com/qShipyard/narratorlog/tree/feat/personal-pr-activity/apps 'apps')
...
[deploy](https://github.com/qShipyard/narratorlog/tree/feat/personal-pr-activity/deploy 'deploy')
...
[docs](https://github.com/qShipyard/narratorlog/tree/feat/personal-pr-activity/docs 'docs')
...
[packages](https://github.com/qShipyard/narratorlog/tree/feat/personal-pr-activity/packages 'packages')
...
[plugins](https://github.com/qShipyard/narratorlog/tree/feat/personal-pr-activity/plugins 'plugins')
...
[.dockerignore](https://github.com/qShipyard/narratorlog/blob/feat/personal-pr-activity/.dockerignore '.dockerignore')
...
[.gitignore](https://github.com/qShipyard/narratorlog/blob/feat/personal-pr-activity/.gitignore '.gitignore')
...
[.narratorlog.yml](https://github.com/qShipyard/narratorlog/blob/feat/personal-pr-activity/.narratorlog.yml '.narratorlog.yml')
...
[CONTRIBUTING.md](https://github.com/qShipyard/narratorlog/blob/feat/personal-pr-activity/CONTRIBUTING.md 'CONTRIBUTING.md')
...
[LICENSE](https://github.com/qShipyard/narratorlog/blob/feat/personal-pr-activity/LICENSE 'LICENSE')
...
[README.md](https://github.com/qShipyard/narratorlog/blob/feat/personal-pr-activity/README.md 'README.md')
...
[ROADMAP.md](https://github.com/qShipyard/narratorlog/blob/feat/personal-pr-activity/ROADMAP.md 'ROADMAP.md')
...
[package.json](https://github.com/qShipyard/narratorlog/blob/feat/personal-pr-activity/package.json 'package.json')
...
[pnpm-lock.yaml](https://github.com/qShipyard/narratorlog/blob/feat/personal-pr-activity/pnpm-lock.yaml 'pnpm-lock.yaml')
...
[pnpm-workspace.yaml](https://github.com/qShipyard/narratorlog/blob/feat/personal-pr-activity/pnpm-workspace.yaml 'pnpm-workspace.yaml')
...
[turbo.json](https://github.com/qShipyard/narratorlog/blob/feat/personal-pr-activity/turbo.json 'turbo.json')
...
Read the [Contributing Guide](https://github.com/qShipyard/narratorlog/blob/feat/personal-pr-activity/docs/contributing/08-contributing-guide.md) to get started.
...
| Doc | Description |
| --- | --- |
| [Problem Statement](https://github.com/qShipyard/narratorlog/blob/feat/personal-pr-activity/docs/01-problem-statement.md) | Why narratorlog exists |
| [Product Requirements](https://github.com/qShipyard/narratorlog/blob/feat/personal-pr-activity/docs/02-product-requirements.md) | What it does and for who |
| [Architecture](https://github.com/qShipyard/narratorlog/blob/feat/personal-pr-activity/docs/03-architecture.md) | How it is built |
| [Database Schema](https://github.com/qShipyard/narratorlog/blob/feat/personal-pr-activity/docs/04-database-schema.md) | Data model |
| [Pipeline Spec](https://github.com/qShipyard/narratorlog/blob/feat/personal-pr-activity/docs/05-pipeline-spec.md) | The 8-stage pipeline |
| [API Design](https://github.com/qShipyard/narratorlog/blob/feat/personal-pr-activity/docs/06-api-design.md) | REST API reference |
| [Plugin Interface](https://github.com/qShipyard/narratorlog/blob/feat/personal-pr-activity/docs/07-plugin-interface-spec.md) | How to build plugins |
| [Contributing](https://github.com/qShipyard/narratorlog/blob/feat/personal-pr-activity/docs/contributing/08-contributing-guide.md) | How to contribute |
