# Source: https://github.com/qShipyard/narratorlog/tree/feat/personal-shipping-log
...
[53 Commits](https://github.com/qShipyard/narratorlog/commits/feat/personal-shipping-log/)
...
[.github](https://github.com/qShipyard/narratorlog/tree/feat/personal-shipping-log/.github '.github')
...
[apps](https://github.com/qShipyard/narratorlog/tree/feat/personal-shipping-log/apps 'apps')
...
[deploy](https://github.com/qShipyard/narratorlog/tree/feat/personal-shipping-log/deploy 'deploy')
...
[docs](https://github.com/qShipyard/narratorlog/tree/feat/personal-shipping-log/docs 'docs')
...
[packages](https://github.com/qShipyard/narratorlog/tree/feat/personal-shipping-log/packages 'packages')
...
[plugins](https://github.com/qShipyard/narratorlog/tree/feat/personal-shipping-log/plugins 'plugins')
...
[.dockerignore](https://github.com/qShipyard/narratorlog/blob/feat/personal-shipping-log/.dockerignore '.dockerignore')
...
[.gitignore](https://github.com/qShipyard/narratorlog/blob/feat/personal-shipping-log/.gitignore '.gitignore')
...
[.narratorlog.yml](https://github.com/qShipyard/narratorlog/blob/feat/personal-shipping-log/.narratorlog.yml '.narratorlog.yml')
...
[CONTRIBUTING.md](https://github.com/qShipyard/narratorlog/blob/feat/personal-shipping-log/CONTRIBUTING.md 'CONTRIBUTING.md')
...
[LICENSE](https://github.com/qShipyard/narratorlog/blob/feat/personal-shipping-log/LICENSE 'LICENSE')
...
[README.md](https://github.com/qShipyard/narratorlog/blob/feat/personal-shipping-log/README.md 'README.md')
...
[ROADMAP.md](https://github.com/qShipyard/narratorlog/blob/feat/personal-shipping-log/ROADMAP.md 'ROADMAP.md')
...
[package.json](https://github.com/qShipyard/narratorlog/blob/feat/personal-shipping-log/package.json 'package.json')
...
[pnpm-lock.yaml](https://github.com/qShipyard/narratorlog/blob/feat/personal-shipping-log/pnpm-lock.yaml 'pnpm-lock.yaml')
...
[pnpm-workspace.yaml](https://github.com/qShipyard/narratorlog/blob/feat/personal-shipping-log/pnpm-workspace.yaml 'pnpm-workspace.yaml')
...
[turbo.json](https://github.com/qShipyard/narratorlog/blob/feat/personal-shipping-log/turbo.json 'turbo.json')
...
Read the [Contributing Guide](https://github.com/qShipyard/narratorlog/blob/feat/personal-shipping-log/docs/contributing/08-contributing-guide.md) to get started.
...
| Doc | Description |
| --- | --- |
| [Problem Statement](https://github.com/qShipyard/narratorlog/blob/feat/personal-shipping-log/docs/01-problem-statement.md) | Why narratorlog exists |
| [Product Requirements](https://github.com/qShipyard/narratorlog/blob/feat/personal-shipping-log/docs/02-product-requirements.md) | What it does and for who |
| [Architecture](https://github.com/qShipyard/narratorlog/blob/feat/personal-shipping-log/docs/03-architecture.md) | How it is built |
| [Database Schema](https://github.com/qShipyard/narratorlog/blob/feat/personal-shipping-log/docs/04-database-schema.md) | Data model |
| [Pipeline Spec](https://github.com/qShipyard/narratorlog/blob/feat/personal-shipping-log/docs/05-pipeline-spec.md) | The 8-stage pipeline |
| [API Design](https://github.com/qShipyard/narratorlog/blob/feat/personal-shipping-log/docs/06-api-design.md) | REST API reference |
| [Plugin Interface](https://github.com/qShipyard/narratorlog/blob/feat/personal-shipping-log/docs/07-plugin-interface-spec.md) | How to build plugins |
| [Contributing](https://github.com/qShipyard/narratorlog/blob/feat/personal-shipping-log/docs/contributing/08-contributing-guide.md) | How to contribute |
