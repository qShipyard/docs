# Source: https://github.com/qShipyard/narratorlog/tree/feat/flow-adjuctment-fix
...
[Merge branch 'dev' into feat/flow-adjuctment-fix](https://github.com/qShipyard/narratorlog/commit/b297d3e1f91485f47665f9e25508382264d38e59)

failure

Jul 1, 2026

[b297d3e](https://github.com/qShipyard/narratorlog/commit/b297d3e1f91485f47665f9e25508382264d38e59) · Jul 1, 2026

## History

[57 Commits](https://github.com/qShipyard/narratorlog/commits/feat/flow-adjuctment-fix/)
...
[.github](https://github.com/qShipyard/narratorlog/tree/feat/flow-adjuctment-fix/.github '.github')
...
[apps](https://github.com/qShipyard/narratorlog/tree/feat/flow-adjuctment-fix/apps 'apps')
...
[deploy](https://github.com/qShipyard/narratorlog/tree/feat/flow-adjuctment-fix/deploy 'deploy')
...
[docs](https://github.com/qShipyard/narratorlog/tree/feat/flow-adjuctment-fix/docs 'docs')
...
[packages](https://github.com/qShipyard/narratorlog/tree/feat/flow-adjuctment-fix/packages 'packages')
...
[plugins](https://github.com/qShipyard/narratorlog/tree/feat/flow-adjuctment-fix/plugins 'plugins')
...
[.dockerignore](https://github.com/qShipyard/narratorlog/blob/feat/flow-adjuctment-fix/.dockerignore '.dockerignore')
...
[.gitignore](https://github.com/qShipyard/narratorlog/blob/feat/flow-adjuctment-fix/.gitignore '.gitignore')
...
[.narratorlog.yml](https://github.com/qShipyard/narratorlog/blob/feat/flow-adjuctment-fix/.narratorlog.yml '.narratorlog.yml')
...
[CONTRIBUTING.md](https://github.com/qShipyard/narratorlog/blob/feat/flow-adjuctment-fix/CONTRIBUTING.md 'CONTRIBUTING.md')
...
[LICENSE](https://github.com/qShipyard/narratorlog/blob/feat/flow-adjuctment-fix/LICENSE 'LICENSE')
...
[README.md](https://github.com/qShipyard/narratorlog/blob/feat/flow-adjuctment-fix/README.md 'README.md')
...
[ROADMAP.md](https://github.com/qShipyard/narratorlog/blob/feat/flow-adjuctment-fix/ROADMAP.md 'ROADMAP.md')
...
[package.json](https://github.com/qShipyard/narratorlog/blob/feat/flow-adjuctment-fix/package.json 'package.json')
...
[pnpm-lock.yaml](https://github.com/qShipyard/narratorlog/blob/feat/flow-adjuctment-fix/pnpm-lock.yaml 'pnpm-lock.yaml')
...
[pnpm-workspace.yaml](https://github.com/qShipyard/narratorlog/blob/feat/flow-adjuctment-fix/pnpm-workspace.yaml 'pnpm-workspace.yaml')
...
[turbo.json](https://github.com/qShipyard/narratorlog/blob/feat/flow-adjuctment-fix/turbo.json 'turbo.json')
...
Read the [Contributing Guide](https://github.com/qShipyard/narratorlog/blob/feat/flow-adjuctment-fix/docs/contributing/08-contributing-guide.md) to get started.
...
| Doc | Description |
| --- | --- |
| [Problem Statement](https://github.com/qShipyard/narratorlog/blob/feat/flow-adjuctment-fix/docs/01-problem-statement.md) | Why narratorlog exists |
| [Product Requirements](https://github.com/qShipyard/narratorlog/blob/feat/flow-adjuctment-fix/docs/02-product-requirements.md) | What it does and for who |
| [Architecture](https://github.com/qShipyard/narratorlog/blob/feat/flow-adjuctment-fix/docs/03-architecture.md) | How it is built |
| [Database Schema](https://github.com/qShipyard/narratorlog/blob/feat/flow-adjuctment-fix/docs/04-database-schema.md) | Data model |
| [Pipeline Spec](https://github.com/qShipyard/narratorlog/blob/feat/flow-adjuctment-fix/docs/05-pipeline-spec.md) | The 8-stage pipeline |
| [API Design](https://github.com/qShipyard/narratorlog/blob/feat/flow-adjuctment-fix/docs/06-api-design.md) | REST API reference |
| [Plugin Interface](https://github.com/qShipyard/narratorlog/blob/feat/flow-adjuctment-fix/docs/07-plugin-interface-spec.md) | How to build plugins |
| [Contributing](https://github.com/qShipyard/narratorlog/blob/feat/flow-adjuctment-fix/docs/contributing/08-contributing-guide.md) | How to contribute |
